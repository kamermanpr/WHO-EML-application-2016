############################################################
#                                                          #
#       Dizziness meta-analysis of gabapentin studies      #
#                                                          #
############################################################
# Load packages
library(readr)
...
# Import data
#############
meta_analysis <- read_csv('./data/dizziness_meta.analysis.csv')
...
text(-1.5, pos = 4, c(16, 7), c("Low risk of bias",
