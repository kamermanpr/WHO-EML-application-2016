############################################################
#                                                          #
#      Somnolence meta-analysis of gabapentin studies      #
#                                                          #
############################################################
# Load packages
library(readr)
...
# Import data
#############
meta_analysis <- read_csv('./data/somnolence_meta.analysis.csv')
...
text(-1.5, pos = 4, c(16, 8), c("Low risk of bias",
...
## Add column labels
text(x = -1.5, y = 17.5, pos = 4, labels = 'Study (CONDITION)')
text(x = 1.02, y = 17.5, labels = 'Weight', font = 2)
text(x = 1.25, y = 18.5, pos = 4, labels = 'Risk Difference')
text(x = 1.4, y = 17.5, pos = 4, labels = '[95% CI]')
